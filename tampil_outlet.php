...
?>
    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr class="table-primary">
                <th>NO</th><th>ID</th><th>ALAMAT</th><th>TELEPON</th><th>CABANG</th><th>AKSI</th>
            </tr>
        </thead>
        <tbody>
            <?php
    ...
    <a href="tambah_outlet.php" class="btn btn-danger" style="padding:5px 10px; float:left;">Tambah Outlet</a>
    <script
