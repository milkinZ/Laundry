...
?>
    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr class="table-primary">
                <th>NO</th><th>ID</th><th>NAMA</th><th>ALAMAT</th><th>JENIS KELAMIN</th><th>TELEPON</th><th>AKSI</th>
            </tr>
        </thead>
        <tbody>
            <?php
    ...
    <a href="tambah_member.php" class="btn btn-danger" style="padding:5px 10px; float:left;">Tambah Member</a>
    <script
